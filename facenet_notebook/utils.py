...
def conv2d_bn(
  ...
  tensor = BatchNormalization(axis=3, epsilon=0.00001, name=layer+'_bn'+num,moving_mean_initializer='zeros',moving_variance_initializer='ones', beta_initializer='zeros',scale=True)(tensor)
  ...
  tensor = BatchNormalization(axis=3, epsilon=0.00001, name=layer+'_bn'+'2',moving_mean_initializer='zeros',moving_variance_initializer='ones', beta_initializer='zeros',scale=True)(tensor)
  tensor.trainable = False
  tensor = Activation('relu')(tensor)
  return tensor
